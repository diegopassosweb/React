...
export default function App(){
    ...
    return (
        <>
    <Nota num={1} nome={'nota1'}notas={notas.nota1} setNota={handleSetNotas} />
    <Nota num={2} nome={'nota2'}notas={notas.nota2} setNota={handleSetNotas}/>
    <Nota num={3} nome={'nota3'}notas={notas.nota3} setNota={handleSetNotas}/>
    <Nota num={4} nome={'nota4'}notas={notas.nota4} setNota={handleSetNotas}/>
